...
import type { ControlSequenceBegin, ControlSequenceEnd, Message } from './msbt.mjs';
import { formatMessage as format } from './format.mjs';
...
export function formatMessage<State extends object>(
	message: Message,
	state: State,
