...
import { MSBP } from '@game-scripts/tools/parsers/nintendo/message-studio/msbp.js';
...
const msbp = Object.fromEntries(locales.map((locale) => [locale, new MSBP(url.join(root, locale, "richard.msbp"))] as const));
