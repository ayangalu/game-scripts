...
import type { MarkupTag, TransformerTree } from '@game-scripts/tools/parsers/nintendo/message-studio/util/format-html.js';
import { ControlCode } from '@game-scripts/tools/parsers/nintendo/message-studio/msbt.js';
import { colorTransformer, placeholderTransformer, rubyTransformer, variableTransformer } from '@game-scripts/tools/parsers/nintendo/message-studio/util/format-html.js';
